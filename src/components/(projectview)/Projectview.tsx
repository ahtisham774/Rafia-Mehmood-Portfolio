        ...
        <div className=" relative  bg-white ">
            ...
            <img src="/assets/home-images/projectview/vecter.png" alt="Orange Vector"  className="z-0 absolute top-0 left-0 md:w-[35%] h-[85%] lg:block hidden" />
                   <div className="absolute top-10 left-20 w-full h-full lg:block hidden">
                       <img
                           src="/assets/home-images/projectview/home.png"
                           alt="Grocery app interface"
                           className="rounded-2xl z-10 absolute object-contain top-14 left-2 h-[45%] lg:block hidden"
                       />

                       <img
                           src="/assets/home-images/projectview/login.png"
                           alt="Grocery app interface"
            ...
            <div className="w-full mx-auto md:py-32 py-10 md:max-w-[900px] max-w-full md:pl-72 pl-0 relative z-[999]">
                ...
                <div className="w-full md:px-0 px-5">
                    ...
                    <h1 className="md:text-[68px] text-[40px] font-bold text-orange-500 tracking-wide mb-6">GROCER</h1>

                    <p className="w-full text-[#595959] md:text-[18px] text-base mb-8">
                        Grocery at Home is a mobile application designed to simplify online <br/>
                        grocery shopping. It enables users to easily browse, select, and order <br/>
                        fresh groceries delivered to their doorstep, offering a smooth and <br/>
