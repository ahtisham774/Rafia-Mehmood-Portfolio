...
const DesignSystem = () => {
    ...
    const colors = [
        { hex: '#237A23', label: '#237A23' },
        { hex: '#1D8E1D', label: '#1D8E1D' },
        { hex: '#9ED59E', label: '#9ED59E' },
        { hex: '#D42626', label: '#D42626' },
        { hex: '#FFB81D', label: '#FFB81D' },
        { hex: '#262626', label: '#262626' },
    ];
                ...
                <div className="flex flex-col md:flex-row gap-12">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="font-roboto">
                            <p className="text-[30px] uppercase mb-4 font-bold text-[#595959] font-[roboto]">ROBOTO</p>
