        ...
        <div className=" relative  bg-white ">
            ...
            <div className="w-full mx-auto md:py-32 py-10 md:max-w-[900px] max-w-full md:pl-72 pl-0 relative z-[999]">
                ...
                <div className="w-full md:px-0 px-5">
                    <Link href="/projects" className="flex items-center mb-4">
                        ...
                        <h2 className="text-xl px-5 text-black md:text-[40px] text-[25px]">Posters</h2>
                    </Link>

                    <div className="mb-6">
                        <h3 className="text-gray-500 font-medium mb-2">Tool Used</h3>
                        <div className="flex items-center">
                            <img src="/assets/home-images/posters/ai.png" alt="Figma Logo" className="w-4 h-4 mr-2" />
                            <span className="font-medium text-[20px]">Adobe Illustator</span>
                        </div>
                    </div>
                    <div className="mb-6">
                        <div className="flex items-center">
                            <img src="/assets/home-images/posters/ps.png" alt="Figma Logo" className="w-4 h-4 mr-2" />
                            <span className="font-medium text-[20px]">Adobe Photoshop</span>
                        </div>
                    </div>
                    <div className="mb-6">
                        <div className="flex items-center">
                            <img src="/assets/home-images/posters/canva.png" alt="Figma Logo" className="w-4 h-4 mr-2" />
                            <span className="font-medium text-[20px]">Canva</span>
                        </div>
                    </div>
                </div>
